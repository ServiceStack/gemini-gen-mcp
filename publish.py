#!/usr/bin/env python3
"""
Script to help publish the gemini-gen-mcp package to PyPI.
...
def create_release():
    ...
    print(f"View at: https://github.com/ServiceStack/gemini-gen-mcp/releases/tag/{tag}")


def main():
    parser = argparse.ArgumentParser(description="Publish gemini-gen-mcp package to PyPI")
